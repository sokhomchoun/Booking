          ...
          <form action="{{url('updatecat/'.$item->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="category_header">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="clearId" name="category_no" value="{{$item->category_no}}">
              </div>
              <div class="mb-3">
                <label for="" class="form-label">Name</label>
                <input type="text" class="form-control" id="clearName" name="category_name" value="{{$item->category_name}}">
              </div>
    
              <div class="mb-3">
                <label for="" class="form-label">Image</label>
                <input type="file" class="form-control" placeholder="Hotel Name" name="category_image">
                <img src="{{ asset('uploads/photos/'.$item->category_image) }}" alt="" id="size_image">
              </div>
            </div>
