          ...
          <form action="{{ url('updatecam/'.$item->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="category_header">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="clearId" name="category_no" value="{{$item->id}}" disabled>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <img src="{{ asset('uploads/photos/'.$item->province_image) }}" alt="" id="size_image">
              </div>
            </div>
